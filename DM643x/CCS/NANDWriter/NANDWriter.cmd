...
SECTIONS
{
	...
	{
    . += 0x1000;
	} load = AEMIF, FILL=0x00000000, type=DSECT, START(_NANDStart)
  ...
  {
    . += 0x1000;
  } load = L2RAM, FILL=0x00000000, START(_EXTERNAL_RAM_START), END(_EXTERNAL_RAM_END), SIZE(_EXTERNAL_RAM_SIZE)
}